...
<div class="min-h-screen bg-neutral-100 dark:bg-neutral-900">
  ...
  <main class="flex items-center justify-center px-4 py-8">
    <div class="w-full max-w-lg">
      <div class="bg-white dark:bg-neutral-800 rounded-2xl shadow-lg border border-neutral-200 dark:border-neutral-700 p-8">
        <!-- Header -->
          ...
          <form on:submit|preventDefault={handleSubmit} class="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                class="w-full px-4 py-3 bg-neutral-100 dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-600 rounded-lg text-neutral-900 dark:text-white placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-secondary-500 focus:border-transparent transition-colors"
              />
            </div>
            ...
            <div>
              ...
              <textarea
                ...
                disabled={isSubmitting}
                required
                class="w-full px-4 py-3 bg-neutral-100 dark:bg-neutral-700 border border-neutral-300 dark:border-neutral-600 rounded-lg text-neutral-900 dark:text-white placeholder-neutral-400 focus:outline-none focus:ring-2 focus:ring-secondary-500 focus:border-transparent resize-none transition-colors"
              ></textarea>
            ...
            <div class="flex gap-3">
              <button
                ...
                on:click={handleSkip}
                disabled={isSubmitting}
                class="flex-1 px-6 py-3 border-2 border-neutral-300 dark:border-neutral-600 text-neutral-700 dark:text-neutral-300 rounded-lg font-medium hover:bg-neutral-100 dark:hover:bg-neutral-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Skip & Go Home
              </button>
              <button
                ...
                class="flex-1 px-6 py-3 bg-secondary-500 text-white rounded-lg font-medium hover:bg-secondary-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {#if isSubmitting}
